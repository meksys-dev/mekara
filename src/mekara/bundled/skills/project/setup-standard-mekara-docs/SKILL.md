---
name: setup-standard-mekara-docs
description: Sets up or restructures a documentation site to follow standard Mekara documentation conventions with usage/, development/, and code-base/ sections.
---
