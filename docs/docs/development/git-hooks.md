...
| Skill frontmatter       | Any change to a `SKILL.md` file under `.mekara/scripts/nl/`, `.agents/skills/`, or `.claude/skills/` | Validates Agent Skills YAML frontmatter and field requirements.                                                            |
